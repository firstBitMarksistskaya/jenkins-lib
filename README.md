...
1. Coverage41C не запускается в Windows на мастер-ноде Jenkins, для его корректной работы нужно запустить и настроить агент Jenkins и выполнять сборки на нем.
